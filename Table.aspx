<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Table.aspx.cs" Inherits="DataBase.Home" %>
       ...
       <asp:TemplateField HeaderText="Patient ID" >
            ...
            <HeaderTemplate>
                ...
                <asp:LinkButton ID="lbtnDelete" runat="server" OnCommand="Delete_Click" 
                    CommandName="lbtnDelete" CommandArgument='<%#Eval("pat_ID") %>'>Delete</asp:LinkButton>
            </HeaderTemplate>
           

    <ItemTemplate> 
<asp:CheckBox ID="chkStudentID" runat="server" AutoPostBack="false" /> 
        <asp:Label ID="hidStudentID" runat="server" Text='<%#Eval("pat_ID") %>' Visible="false"></asp:Label>
</ItemTemplate>
</asp:TemplateField>
      ...
      DataNavigateUrlFormatString="Display.aspx?ID={0} &type=view"           
       HeaderText="View" Text="View" runat="server" Target="_blank" >  
        ...
        <asp:TemplateField HeaderText="View">
            <ItemTemplate>
                <asp:Button ID="btnView" text="View" runat="server" CommandArgument='<% # Eval  ("pat_ID") %>' OnCommand="btnView_Click"   
              CommandName="btnView"  />
                </ItemTemplate>
            </asp:TemplateField>
 ...
 <asp:TemplateField HeaderText="Edit">
            <ItemTemplate>
                ...
                CommandArgument='<% # Eval  ("pat_ID") %>'>Edit</asp:LinkButton>&nbsp;&nbsp;
                <asp:ImageButton ID="imgDelete" runat="server" CommandArgument='<% # Eval  ("pat_ID") %>' OnCommand="Delete_Click"   
              CommandName="lbtnDelete" ImageUrl="~/images/delete.jpg" Height ="30"  Width ="30" />||
           <asp:ImageButton ID="imgEdit" runat="server" CommandArgument='<% # Eval  ("pat_ID") %>' OnCommand="lbtnEdit_Click"   
          ...
          <asp:ImageButton ID="imgDelete" runat="server" CommandArgument='<% # Eval  ("pat_ID") %>' OnCommand="Delete_Click"   
           ...
           <asp:ImageButton ID="imgEdit" runat="server" CommandArgument='<% # Eval  ("pat_ID") %>' OnCommand="lbtnEdit_Click"   
            ...
            <asp:TemplateField HeaderText="Prescriptions">
                <ItemTemplate>
        <asp:Button ID="btnRefillView" OnCommand="btnRefillView_Click" CommandArgument='<% # Eval  ("pat_ID") %>'          
       HeaderText="Refills" Text="View" runat="server" Target="_blank" >  
                
            </asp:Button>
                    <asp:Button ID="btnRefillAdd" OnCommand="btnRefillAdd_Click" CommandArgument='<% # Eval  ("pat_ID") %>'          
       HeaderText="Refills" Text="Add" runat="server" Target="_blank" >  
